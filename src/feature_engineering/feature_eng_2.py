...
def main():
    ...
    df20162017.to_csv('data/FE2/20162017_clean.csv', encoding='utf-8', index=False)
    ...
    df20172018.to_csv('data/FE2/20172018_clean.csv', encoding='utf-8', index=False)
    ...
    df20182019.to_csv('data/FE2/20182019_clean.csv', encoding='utf-8', index=False)
    ...
    df20192020.to_csv('data/FE2/20192020_clean.csv', encoding='utf-8', index=False)
